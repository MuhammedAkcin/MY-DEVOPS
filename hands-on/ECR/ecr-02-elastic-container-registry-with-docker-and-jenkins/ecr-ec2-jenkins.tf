...
locals {
  ...
  github-username = "Matt"                              # you need to change this line
  github-token = "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"      # you need to change this line
  key_pair="FB1907"            # you need to change this line
  pem_key_address = "~/.ssh/FB1907.pem"              # you need to change this line
}
