...
provider "github" {
  token ="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"
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  key_name = "Matt1907"
  security_groups = ["matt-docker-sec-gr-203"]
  tags = {
  ...
  user_data = <<-EOF
    ...
    TOKEN="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"
    FOLDER="https://$TOKEN@raw.githubusercontent.com/C9198-Mete/bookstore-repo/main/"
